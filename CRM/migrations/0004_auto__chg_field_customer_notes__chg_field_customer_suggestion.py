...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'customer.notes'
        db.alter_column('CRM_customer', 'notes', self.gf('django.db.models.fields.TextField')(max_length=100))

        # Changing field 'customer.suggestion'
        db.alter_column('CRM_customer', 'suggestion', self.gf('django.db.models.fields.TextField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'customer.notes'
        db.alter_column('CRM_customer', 'notes', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'customer.suggestion'
        db.alter_column('CRM_customer', 'suggestion', self.gf('django.db.models.fields.CharField')(max_length=100))
