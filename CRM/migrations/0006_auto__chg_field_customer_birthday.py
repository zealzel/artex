...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'customer.birthday'
        db.alter_column('CRM_customer', 'birthday', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'customer.birthday'
        db.alter_column('CRM_customer', 'birthday', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 12, 0, 0)))
