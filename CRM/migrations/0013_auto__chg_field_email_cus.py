...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'email.cus'
        db.alter_column('CRM_email', 'cus_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['CRM.customer']))

    def backwards(self, orm):

        # Changing field 'email.cus'
        db.alter_column('CRM_email', 'cus_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['CRM.country']))
