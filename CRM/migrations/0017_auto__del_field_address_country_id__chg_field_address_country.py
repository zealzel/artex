...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'CRM_address', 'country_id_id')


        # Changing field 'address.country'
        db.alter_column(u'CRM_address', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['CRM.country']))

    def backwards(self, orm):
        # Adding field 'address.country_id'
        db.add_column(u'CRM_address', 'country_id',
