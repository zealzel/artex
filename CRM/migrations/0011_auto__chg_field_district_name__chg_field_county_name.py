...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'district.name'
        db.alter_column(u'CRM_district', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'county.name'
        db.alter_column(u'CRM_county', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'district.name'
        db.alter_column(u'CRM_district', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'county.name'
        db.alter_column(u'CRM_county', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))
