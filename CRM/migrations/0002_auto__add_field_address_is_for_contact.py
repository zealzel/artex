...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'address.is_for_contact'
        db.add_column('CRM_address', 'is_for_contact',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'address.is_for_contact'
        db.delete_column('CRM_address', 'is_for_contact')
    ...
    models = {
        'CRM.address': {
            ...
            'is_for_contact': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
