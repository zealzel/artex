...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'email.cus_id'
        db.delete_column(u'CRM_email', 'cus_id_id')

        # Adding field 'email.cus'
        db.add_column('CRM_email', 'cus',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['CRM.country']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'email.cus_id'
        db.add_column(u'CRM_email', 'cus_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['CRM.customer']),
                      keep_default=False)

        # Deleting field 'email.cus'
        db.delete_column('CRM_email', 'cus_id')
    ...
    models = {
        ...
        'CRM.email': {
            ...
            'cus': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['CRM.country']"}),
            'date_from': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'date_to': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
